...
namespace GameStore.UnitTests
{
    ...
    public class CartTests
    {
        ...
        public void Can_Add_New_Lines()
        {
            ...
            Game game1 = new Game { GameId = 1, Name = "Гра1" };
            Game game2 = new Game { GameId = 2, Name = "Гра2" };
        ...
        public void Can_Remove_Line()
        {
            ...
            Game game1 = new Game { GameId = 1, Name = "Гра1" };
            Game game2 = new Game { GameId = 2, Name = "Гра2" };
            Game game3 = new Game { GameId = 3, Name = "Гра3" };
        ...
        public void Calculate_Cart_Total()
        {
            ...
            Game game1 = new Game { GameId = 1, Name = "Гра1", Price = 100 };
            Game game2 = new Game { GameId = 2, Name = "Гра2", Price = 55 };
        ...
        public void Can_Add_To_Cart()
        {
            ...
            mock.Setup(m => m.Games).Returns(new List<Game> {
                new Game {GameId = 1, Name = "Гра1", Category = "Кат1"},
            }.AsQueryable());
