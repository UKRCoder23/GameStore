...
namespace GameStore.UnitTests
{
    ...
    public class AdminTests
    {
        ...
        public void Index_Contains_All_Games()
        {
            ...
            {
                new Game { GameId = 1, Name = "Гра1"},
                new Game { GameId = 2, Name = "Гра2"},
                new Game { GameId = 3, Name = "Гра3"},
                new Game { GameId = 4, Name = "Гра4"},
                new Game { GameId = 5, Name = "Гра5"}
            });
            ...
            Assert.AreEqual("Гра1", result[0].Name);
            Assert.AreEqual("Гра2", result[1].Name);
            Assert.AreEqual("Гра3", result[2].Name);
        }
        [TestMethod]
        ...
        public void Can_Delete_Valid_Games()
        {
            ...
            Game game = new Game { GameId = 2, Name = "Гра2" };
